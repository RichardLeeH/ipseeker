...
//    private static final String IP_FILE = IPSeeker.class.getResource("/QQWry.dat").toString().substring(5);
    ...
    static public void register(String aPath)
    {
    	if (instance == null)
    	{
        	instance = new IPSeeker(aPath);    		
    	}
    }
    ...
    private IPSeeker(String aPath)  {
        ...
        b3 = new byte[3];
        try {
            ipFile = new RandomAccessFile(aPath, "r");
        } catch (FileNotFoundException e) {
                        System.out.println(IPSeeker.class.getResource(aPath).toString());
